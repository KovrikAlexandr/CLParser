...
TEST(ParserTestSuite, ShortNameTest) {
    ...
    ASSERT_TRUE(parser.Parse(SplitString("app -a value1 -b 15 -c")));
...
TEST(ParserTestSuite, MultiValueTest) {
    ...
    ASSERT_TRUE(parser.Parse(SplitString("app --param1=1 -p 2 --param1=3")));
...
TEST(ParserTestSuite, IntPositionalArgTest) {
    ...
    ASSERT_TRUE(parser.Parse(SplitString("app --Param1=1 2 3 4 5")));
